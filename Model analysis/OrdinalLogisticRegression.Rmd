...
# we fit a model with every predictor besides `Walc_bin` because `Walc_bin` is the binary representation of `Walc`, our response variable
model_80 = polr(Walc ~ . - Walc_bin, data = df_recoded_binary_80, Hess = TRUE)
...
# do not know what 1|2, 2|3, 3|4, 4|5 are
...
# do not know how to eliminate variables
...
# pred_80 = predict(model_80, df_recoded_binary_20)
# pred_80
...
# do not know what this does, how to modify it?
